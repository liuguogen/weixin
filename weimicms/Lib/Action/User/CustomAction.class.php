	...
	public function _getInput($type){
		...
		switch ($type) {
			...
			case 'date':
				...
				break;
            case 'file':
                $str = '<a href="###" onclick="upl()" class="a_upload" style="color:red"><img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" /></a>';
		}
		return $str;
	}
	/*字段类型和匹配项*/
