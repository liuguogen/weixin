...
class LinkAction extends UserAction{
	...
	public function keywordModules(){
		...
		array('module'=>'Fangchan','linkcode'=>'','name'=>'房产中介','sub'=>0,'canselected'=>1,'linkurl'=>'','keyword'=>'找房子','askeyword'=>1),
		array('module'=>'Jiejing','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Jiejing&a=list&token='.$this->token.'&wecha_id={wechat_id}','name'=>'微街景','sub'=>0,'canselected'=>1,'linkurl'=>'','keyword'=>'微街景','askeyword'=>1),
		array('module'=>'Yingyong','linkcode'=>'','name'=>'场景应用','sub'=>0,'canselected'=>1,'linkurl'=>'','keyword'=>'场景应用','askeyword'=>1),
		array('module'=>'Sharetalent','linkcode'=>'','name'=>'分享达人','sub'=>0,'canselected'=>1,'linkurl'=>'','keyword'=>'分享达人','askeyword'=>1),

		array('module'=>'Hforward','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Hforward&a=index&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Hforward'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),
                array('module'=>'Punish','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Red_packet&a=index&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Punish'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),
		);
		//
	...
	public function modules(){
		...
		array('module'=>'Sharetalent','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Sharetalent&a=index&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Sharetalent'],'sub'=>0,'canselected'=>1,'linkurl'=>'','keyword'=>'','askeyword'=>0),
		array('module'=>'Hforward','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Hforward&a=index&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Hforward'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),
                array('module'=>'Punish','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Punish&a=index&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Punish'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),
		);
	...
	public function Hforward(){
		$this->assign('moduleName',$this->modules['Hforward']);
		$db=M('Hforward');
		$where=$this->where;
		$count      = $db->where($where)->count();
		$Page       = new Page($count,5);
		...
		if ($list){
			foreach ($list as $item){
				array_push($items,array('id'=>$item['id'],'name'=>$item['name'],'linkcode'=>'{siteUrl}/index.php?g=Wap&m=Hforward&a=index&token='.$this->token.'&wecha_id={wechat_id}&id='.$item['id'],'linkurl'=>'','keyword'=>$item['keyword']));
			}
		}
		//
		$this->assign('list',$items);
		...
		$this->assign('moduleName',$this->modules['Punish']);
		$db=M('Punish');
		$where=$this->where;
		$count      = $db->where($where)->count();
		$Page       = new Page($count,5);
		...
		if ($list){
			foreach ($list as $item){
				array_push($items,array('id'=>$item['id'],'name'=>$item['name'],'linkcode'=>'{siteUrl}/index.php?g=Wap&m=Punish&a=index&token='.$this->token.'&wecha_id={wechat_id}&id='.$item['id'],'linkurl'=>'','keyword'=>$item['keyword']));
			}
		}
		//
		$this->assign('list',$items);
