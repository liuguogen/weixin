...
class IndexAction extends BaseAction{
	...
	protected function _initialize(){
		parent::_initialize();
		$this->home_theme=$this->home_theme?$this->home_theme:'weimicms';
	...
	public function caseJson(){
		...
		$db=D('Classify');
		$dbs=D('Img');
		$class=$db->where(array('token'=>'weimicms','fid'=>'1076407','status'=>1))->order('sorts DESC')->field('id,name')->select();
		$casesID=array();
		foreach ($class as $sc){
