...
final class Router {
	...
	public function login($token,$openid) {
		...
		//return 'http://verify.weimicms.cn/login/?gw_address=192.168.1.1&gw_port=2060&gw_id='.$thisRouter['gw_id'].'&mac=f8:2f:a8:f8:0e:39&url=wwws.weimicms.cn/index.html?a='.$enstr.'&b='.substr(trim(C('router_key')),0,16);
		return 'http://vvvv.weimicms.cn/verify.wifi?a='.$enstr.'&b='.substr(trim(C('router_key')),0,16);
	}
