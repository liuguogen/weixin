-- 
-- 预带数据的数据表：tp_user_group , tp_function, tp_node,tp_agent_function,tp_estate_nav,tp_role,tp_weather,tp_update_record,tp_dream
--
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=1798 ;
...
CREATE TABLE IF NOT EXISTS `tp_behavior` (
  ...
  PRIMARY KEY (`id`),
  KEY `openid` (`openid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=16253 ;
...
CREATE TABLE IF NOT EXISTS `tp_broker` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=57 ;

-- --------------------------------------------------------

--
-- 表的结构 `tp_broker_client`
--
...
--
-- 表的结构 `tp_distributor_commission_record`
--
...
CREATE TABLE IF NOT EXISTS `tp_diymen_class` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1495 ;
...
CREATE TABLE IF NOT EXISTS `tp_files` (
  ...
  KEY `type` (`type`),
  KEY `token` (`token`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4392 ;
...
CREATE TABLE IF NOT EXISTS `tp_keyword` (
  ...
  KEY `pid` (`pid`),
  KEY `token` (`token`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=13125 ;
...
CREATE TABLE IF NOT EXISTS `tp_lapiao` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='拉票' AUTO_INCREMENT=104 ;

-- --------------------------------------------------------

--
-- 表的结构 `tp_lapiao_record`
--
...
CREATE TABLE IF NOT EXISTS `tp_memberflash` (
  ...
  PRIMARY KEY (`id`),
  KEY `tip` (`tip`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='会员卡头部flash' AUTO_INCREMENT=10 ;

-- --------------------------------------------------------

--
-- 表的结构 `tp_member_business`
--
...
--
-- 表的结构 `tp_member_business_product`
--
...
CREATE TABLE IF NOT EXISTS `tp_member_card_create` (
  ...
  KEY `token` (`token`),
  KEY `cardid` (`cardid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=243881 ;
...
--
-- 表的结构 `tp_microsoft_withdraw`
--

CREATE TABLE IF NOT EXISTS `tp_microsoft_withdraw` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `weimicms_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tp_moopha_template` (
  ...
  KEY `site` (`site`),
  KEY `time` (`time`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2304 ;
...
CREATE TABLE IF NOT EXISTS `tp_product_detail` (
  ...
  PRIMARY KEY (`id`),
  KEY `pid` (`pid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='商品的数量(详细)表' AUTO_INCREMENT=127 ;
...
CREATE TABLE IF NOT EXISTS `tp_sharetalent` (
  ...
  `click` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=54 ;
...
CREATE TABLE IF NOT EXISTS `tp_sharetalent_user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=41 ;
...
CREATE TABLE IF NOT EXISTS `tp_twitter_count` (
  ...
  KEY `twid` (`twid`),
  KEY `token` (`token`,`cid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='分佣统计' AUTO_INCREMENT=7 ;
...
CREATE TABLE IF NOT EXISTS `tp_twitter_log` (
  ...
  KEY `cid` (`cid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='获取佣金记录' AUTO_INCREMENT=34 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4885 ;
...
CREATE TABLE IF NOT EXISTS `tp_voteimg` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=59 ;

-- --------------------------------------------------------

--
-- 表的结构 `tp_voteimg_banner`
--
...
CREATE TABLE IF NOT EXISTS `tp_wechat_group_list` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=32388 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5484 ;
...
CREATE TABLE IF NOT EXISTS `tp_weizhuli` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk ROW_FORMAT=DYNAMIC AUTO_INCREMENT=76 ;

-- --------------------------------------------------------

--
-- 表的结构 `tp_weizhuli_record`
--
...
CREATE TABLE IF NOT EXISTS `tp_weizhuli_user` (
  ...
  `pid` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=59 ;
...
CREATE TABLE IF NOT EXISTS `tp_wzzreplay` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk ROW_FORMAT=DYNAMIC AUTO_INCREMENT=42 ;

-- --------------------------------------------------------

--
-- 表的结构 `tp_xcmreply_info`
--
...
CREATE TABLE IF NOT EXISTS `tp_xinniannq` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nq` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `token` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk ROW_FORMAT=DYNAMIC AUTO_INCREMENT=26 ;

-- --------------------------------------------------------

--
-- 表的结构 `tp_xinniannqreplay`
--
...
CREATE TABLE IF NOT EXISTS `tp_xinniannqreplay` (
  ...
  `mypicurl1` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk ROW_FORMAT=DYNAMIC AUTO_INCREMENT=7 ;
...
CREATE TABLE IF NOT EXISTS `tp_yml_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=7296 ;
...
--
-- 表的结构 `weimicms_member_card_gifts`
--
...
(176, 1, 0, '降价拍', 'Cutprice', '', 1, 1),
(177, 1, 0, '云打包', 'Yundabao', '', 1, 1),
(178, 1, 0, '在线微名片', 'Person_card', '', 1, 1),
...
(101, 'News', '新闻管理', 1, '0', 4, 2, NULL, 0, 2),
(102, 'add', '添加内容', 1, '0', 101, 3, NULL, 0, 2),
(103, 'SystemIndex', '后台首页', 1, '0', 2, 2, NULL, 0, 2);
