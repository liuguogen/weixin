...
'license'=>'<div class="license"><h1>系统安装协议</h1>
				...
				<p>感谢您选择微信公共平台基于 PHP + MySQL   的技术开发，全部源码开放。</p>
			...
			<strong>二、协议许可的权利 </strong>
				...
				<p>2、您可以在协议规定的约束和限制范围内修改 微信公共平台源代码或界面风格以适应您的网站要求。 </p>
			...
			<strong>三、协议规定的约束和限制 </strong>
				...
				<p>3、不管你的网站是否整体使用 微信公共平台，还是部份栏目使用 微信公共平台，在你使用了 微信公共平台的网站主页上必须加上 微信公共平台  官方网址(<a href="http://yunm.taobao.com" target="_blank">yunm.taoao.com</a>)的链接。</p>
				<p>4、未经官方许可，禁止在 微信公共平台  的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
			...
			<strong>四、有限担保和免责声明 </strong>
                ...
                <p align=right>BY 微信公共平台</p>
</div>',
'agreement_yes' => '我同意，继续安装',
'agreement_no' => '我不同意',
'title_install' => ' 微信公共平台V'.SOFT_VERSION.' 安装程序',
...
?>
			<div class="footer">
			    <p>Powered by 微信公共平台(c) v9.1 2013-2015</p>
				<p>版权所有</p>
			</div>
		</div>
		</div>
